<?php 
    ...
    // Check if Email is already exist or not
     ...
     $view_arts_query="select * from user_screen where email = '$email'";
     ...
     if($existing_email != $email){
         $sql="INSERT INTO `user_screen` (`email`,`password`,`type`)VALUES ('$email','$password','$type');";
    ...
    window.history.back();
     ...
     <?php
        ...
        echo '<script type="text/javascript"> window.open("user_screen.php","_self")</script>';
     }
