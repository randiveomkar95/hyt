					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-7 col-auto">
								<h3 class="page-title">Vice President</h3>
								<ul class="breadcrumb">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
			        ...
			        $view_arts_query="select * from authorities where type = 'vice_president'";
								...
								<div class="row form-row">
									<div class="col-12 col-sm-12">
										<div class="form-group">
											...
											<input type="hidden" name="type" value="vice_president">
										</div>
									</div>
<!-- 									<div class="col-12 col-sm-6">
										<div class="form-group">
