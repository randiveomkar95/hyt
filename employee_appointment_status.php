                ...
                <div class="content container-fluid">
					...
					<div class="page-header" style="margin-top:-25px;">
						<div class="row">
							<div class="col-sm-12">
								<ul class="breadcrumb">
									<li class="breadcrumb-item">Appointments Status</li>
								</ul>
							</div>
						</div>
					</div>
...
<input type="button" name="range" id="range" value="Search" class="btn btn-primary float-right form-control"/>
 				 ...
 				 <?php
			        ...
			        while($row=mysqli_fetch_array($run))
			        {
				        ...
				        //Fetch Meeting Partners data
				        $meeting_partner_list = str_replace(',', "' or email='",$meeting_partner);
				        $meeting_partner_list1 = str_replace("' ", "'",$meeting_partner_list);
				        // $meeting_partner_list1 .= " ' ";	


				        // echo $meeting_partner_list1; die;

				        	$view_arts_query11="select * from authorities where email = '$meeting_partner_list1'";

				        	// echo $view_arts_query11; die;
					        $run11=mysqli_query($conn,$view_arts_query11);
					        ...
					        // 	echo "<pre>";
					      		// $name11 = var_dump($row['name']);
					      		// echo "</pre>";
					        }

  							// echo $name11; die;
  							// $meeting_partner1 = implode(',', $name11);
...
{
$.ajax({
url:"emp_appt_status.php?email=<?php echo $_SESSION['email']; ?>",
method:"POST",
