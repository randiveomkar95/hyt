...
$email = $_GET['email'];
				...
				$sql="SELECT * FROM appointments where booking_with='$email' and status='Rejected' and booking_date = '$date' order by id desc";
		...
		<tr>
			...
			<td style="text-align:center;">
					<div class="table-action">
						...
						<a href="javascript:void()"><button type="button" name="reject" class="btn btn-sm bg-danger-light" id="'.$id.'"><i class="fas fa-times"></i> Rejected</button></a>
