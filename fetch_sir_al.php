...
include "inc/conn.php";
									        	...
									        	$view_arts_query22="select DISTINCT emp_name ,meeting_id,status from group_appointments where waiting_area = 'Yes' and permission='Yes' and meeting_id = '10' order by id desc";
	...
	$sql="SELECT * FROM appointments where booking_with='sir@admin.com' and status ='Accepted' and booking_date <= '$date' order by modified_at desc limit 1";
...
$output = '
<div class="table-responsive" style="height:200px;" id="sir_accepted_user_data">
<table class="table table-hover table-center mb-0">
	<tr>
		<th>ID</th>
		<th>Employee Name</th>
...
while($row=mysqli_fetch_array($run))
{
		...
		$output .= '
		<tr style="background-color: #F6DBE0;">
			<td>'.$id.'</td>
