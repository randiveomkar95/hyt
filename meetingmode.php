...
<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="modal-title" style="margin-left: 250px;"><?php if($modes == "meeting"){ echo "Meeting Mode is already Activated";} else{ echo "You are going to activate Meeting Mode"; }; ?></h3>

						<!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times; </span></button> -->
					</div>
					<form method="post" action="mode_status_update.php" style="display: <?php if($modes == "meeting"){ echo "none"; }else{} ?>">
